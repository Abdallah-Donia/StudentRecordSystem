...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point, 
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(147, 137);
			...
			// id_txt
			// 
			this->id_txt->Location = System::Drawing::Point(65, 60);
			this->id_txt->Margin = System::Windows::Forms::Padding(3, 2, 3, 2);
			this->id_txt->Name = L"id_txt";
			this->id_txt->Size = System::Drawing::Size(165, 20);
			this->id_txt->TabIndex = 3;
			this->id_txt->TextChanged += gcnew System::EventHandler(this, &Form8::textBox1_TextChanged);
			// 
			// Form8
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(242, 214);
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
				...
				while(readed=sr->ReadLine())
				{
					...
					{
						flag=true;
						MessageBox::Show("Record is found","Succesful",MessageBoxButtons::OK,MessageBoxIcon::Question);
					}
				}
				if(flag!=true)
				{
